...
(function($){
	...
	function shareLink(st,sq,tweetId){
		...
		var s = '<a href="http://www.facebook.com/sharer.php?u='+sq+'&t='+st+'" class="pin-share-facebook"></a>';
		s += '<a href="https://twitter.com/share?url='+sq+'&text='+st+'&via='+tweetId+'" class="pin-share-twitter"></a>';
		return s;
    }
